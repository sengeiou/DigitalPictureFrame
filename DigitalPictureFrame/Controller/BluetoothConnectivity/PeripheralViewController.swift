...
class PeripheralViewController: UIViewController, UITableViewDelegate, UITableViewDataSource, BluetoothDelegate {
  ...
  @IBOutlet weak var peripheralUUIDLbl: UILabel!
  @IBOutlet weak var connectFlagLbl: UILabel!
  ...
  func initAll() {
    ...
    peripheralNameLbl.text = sharedBluetoothManager.connectedPeripheral?.name
    peripheralUUIDLbl.text = sharedBluetoothManager.connectedPeripheral?.identifier.uuidString
    reloadTableView()
  }
