//
//  BluetoothUnavailableView.swift
//  DigitalPictureFrame
//
...
class BluetoothUnavailableView: UIView {
  static private let sharedInstance = BluetoothUnavailableView()
...
extension BluetoothUnavailableView: ViewSetupable {
  ...
  func setup() {
    ...
    tip1Lbl.font = UIFont.systemFont(ofSize: 18, weight: .thin)
    ...
    tip2Lbl.font = UIFont.systemFont(ofSize: 12, weight: .light)
...
// MARK: - Show/Hide view
extension BluetoothUnavailableView {
